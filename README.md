<h1>Hi, I'm Kawsar Ahmed</h1>

Senior Full Stack Software Engineer with 9+ years of experience building scalable, high-performance web applications.

I specialize in **system design, distributed architectures, and algorithmic problem-solving**, with strong expertise in modern backend and frontend ecosystems. I enjoy transforming complex requirements into clean, maintainable, and efficient systems.

### 💻 Tech Stack

- **Backend:** Node.js, NestJS, Laravel, Django, Flask  
- **Frontend:** React, Vue  
- **Languages:** JavaScript, TypeScript, PHP, Python  
- **Database:** MySQL, PostgreSQL, MongoDB  
- **Cloud / DevOps:** AWS (EC2, S3, Lambda, RDS), Docker, CI/CD  
- **Architecture:** Microservices, REST APIs, GraphQL, Scalable System Design 
...
- 🔭 I’m a **Senior Software Engineer** focusing on scalable system design, algorithm optimization, and full-stack development.  
